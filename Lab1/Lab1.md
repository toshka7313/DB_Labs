...
* інформацію про пацієнтів (особисті та контактні дані)
...
| appointment_id (FK) | Прийом, за результатами якого виписано рецепт |
| medication_name | Назва лікарського препарату |
